...
var wight = 85.5
var BMI = 65.5
func BMI(hight:Double,wight:Double) -> String {
    if BMI <= 18.5 {
        return("ضعيف")
    }
...
var name = "salem"
var age = "16"
func driversLicense(name:String,age:String) -> String {
    if age >= "18" {
        return"يُسمح له بإمتلاك رخصة قيادة"
    }
    else {
        return"المتقدم لم يكمل العمر المطلوب"
    }
}
